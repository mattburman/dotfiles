...
alias gd='git diff'
alias gdr='git diff "origin/$(git_current_branch)" "$(git_current_branch)"'
...
alias glogmh='git log --oneline --decorate --graph $(git_main_branch)..HEAD'
alias glgmh='git log --stat $(git_main_branch)..HEAD'
alias gshs='git show --stat'
alias gshsmh='git show --stat $(git_main_branch)..HEAD'
